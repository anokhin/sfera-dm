...
Скачать: \href{https://cloud.mail.ru/public/afaf4aac09ab\%2Feuroparl.test.txt}{данные}, \href{https://cloud.mail.ru/public/ce34acc141fd\%2Flang_task.py}{код}
...
\item[D] Выбор признаков \\
{\it Берем топ-$k$ признаков из каждого языка}
\item[D] Инициализация модели \\
{\it Используем один из вариантов NB из sklearn}
\item[T] Качество \\
{\it Построить ROC для одного из классов}
\item[T] Анализ \\
